...
macro_rules! __impl_grid_with_shared {
    (
            ...
            Shared: crate::id::SharedData,
        {
            ...
            pub fn import_shared_data(&mut self, shared_data: crate::id::TypeIdMap<Shared>)
            {
            ...
            /// will not be tracked. In these scenarios it is implied that all tiles were modified and all
            /// objects dependent on the shared data should be updated.
            pub fn export_shared_data(&mut self) -> crate::id::TypeIdMap<Shared> {
...
pub(crate) use __impl_shared_from_regular;

#[cfg(test)]
pub(crate) use __impl_grid_tests;
#[cfg(test)]
pub(crate) use __impl_shared_grid_tests;
