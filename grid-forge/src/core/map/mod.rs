...
//         type TileRef<'a>: TileRef<'a, D, Data>
//         where
//             Data: 'a,
//             Self: 'a;
//         /// Mutable reference to the tile data retrieved from the [`GridMap`].
//         type TileMut<'a>: TileMut<'a, D, Data>
//         where
//             Data: 'a,
//             Self: 'a;
...
//                 "wrong varia on position: {:?}; iter access",
//                 tile.grid_position()
//             );
//         }
...
//                 tile.data().offset,
//                 size.offset(&tile.grid_position()),
//                 "wrong offset on position: {:?}; drain access",
//                 tile.grid_position()
//             );
//         }
//     }
...
//                 "wrong position on remapped position: {:?};",
//                 tile.grid_position()
//             );
//         }
//     }
