...
/// use grid_forge::identifiable::builders::{IdentTileBuilder, IdentTileCloneBuilder};
///
...
/// use grid_forge::{GridPosition, TileData, TileContainer};
/// use grid_forge::identifiable::IdentifiableTileData;
/// use grid_forge::identifiable::builders::{ConstructableViaIdentifierTile, IdentTileBuilder, IdentTileTraitBuilder};
///
/// // Implementing custom TileData supported by `IdentTileCloneBuilder`.
/// #[derive(Clone)]
/// struct MyTileData {
