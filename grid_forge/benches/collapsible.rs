...
fn analyze_adjacency_identity_10x10(c: &mut Criterion) {
  ...
  c.bench_function("analyze_adjacency_identity_10x10", |b| b.iter(|| {
...
fn analyze_adjacency_border_10x10(c: &mut Criterion) {
  ...
  c.bench_function("analyze_adjacency_border_10x10", |b| b.iter(|| {
...
fn analyze_frequency_10x10(c: &mut Criterion) {
  ...
  c.bench_function("analyze_frequency_10x10", |b| b.iter(|| {
...
fn analyze_build_collapsible_grid(c: &mut Criterion) {
  ...
  c.bench_function("analyze_build_collapsible_grid", |b| b.iter(|| {
    let _grid =
...
fn gen_identity_position_10x10(c: &mut Criterion) {
  ...
  c.bench_function("gen_identity_position_10x10", |b| b.iter(|| {
...
fn gen_identity_entrophy_10x10(c: &mut Criterion) {
  ...
  c.bench_function("gen_identity_entrophy_10x10", |b| b.iter(|| {
      // Seed for reproductability
      let mut seed = [0u8; 32];
...
fn gen_border_position_10x10(c: &mut Criterion) {
  ...
  c.bench_function("gen_border_position_10x10", |b| b.iter(|| {
      // Seed for reproductability
...
fn gen_border_entrophy_10x10(c: &mut Criterion) {
  ...
  c.bench_function("gen_border_entrophy_10x10", |b| b.iter(|| {
      // Seed for reproductability
      let mut seed = [0u8; 32];
