...
use grid_forge_2d::image::ops::{
    init_map_image_buffer, load_from_image_const, load_from_image_const_typed, load_from_image_const_typed_auto, load_from_image_var, load_from_image_var_typed, load_from_image_var_typed_auto, write_to_image_const, write_to_image_const_shared, write_to_image_const_typed, write_to_image_var, write_to_image_var_shared, write_to_image_var_typed
};
...
fn load_gridmap_map_var_auto(c: &mut Criterion) {
    ...
    c.bench_function("load_gridmap_map_var_auto", |b| {
        b.iter(|| {
            ...
            let grid_map = load_from_image_var_typed_auto(&image, &builder, (4, 4), &mut pixel_map).unwrap();
